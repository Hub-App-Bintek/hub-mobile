...
class _$FileUploadResponseImpl implements _FileUploadResponse {
  ...
  @override
  String toString() {
    return 'FileUploadResponse(id: $id, originalName: $originalName, fileName: $fileName, fileSize: $fileSize, mimeType: $mimeType, category: $category, subCategory: $subCategory, entityId: $entityId, uploadedAt: $uploadedAt, downloadUrl: $downloadUrl)';
  }
