...
abstract class $ImageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? title, String url, String? description});
}
...
class _$ImageModelImpl implements _ImageModel {
  const _$ImageModelImpl({this.title, required this.url, this.description});
  ...
  @override
  String toString() {
    return 'ImageModel(title: $title, url: $url, description: $description)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, url, description);
