...
_$SubmitSimbgRequestImpl _$$SubmitSimbgRequestImplFromJson(
  ...
  prototypeForm: json['prototypeForm'] == null
      ? null
      : PrototypeForm.fromJson(json['prototypeForm'] as Map<String, dynamic>),
...
Map<String, dynamic> _$$SubmitSimbgRequestImplToJson(
  ...
  final val = <String, dynamic>{'type': instance.type};
...
_$NonPrototypeFormImpl _$$NonPrototypeFormImplFromJson(
  ...
  garisSempadanBangunanGsb: (json['garisSempadanBangunanGsb'] as num)
      .toDouble(),
  koefisienDasarBangunanKdb: (json['koefisienDasarBangunanKdb'] as num)
      .toDouble(),
  koefisienDasarBangunanKdbUnit:
      json['koefisienDasarBangunanKdbUnit'] as String,
  koefisienLantaiBangunanKlb: (json['koefisienLantaiBangunanKlb'] as num)
      .toDouble(),
  koefisienLantaiBangunanKlbUnit:
      json['koefisienLantaiBangunanKlbUnit'] as String,
  koefisienDasarHijauKdh: (json['koefisienDasarHijauKdh'] as num).toDouble(),
  ...
  luasTotalBangunanPerUnit: (json['luasTotalBangunanPerUnit'] as num)
      .toDouble(),
...
Map<String, dynamic> _$$NonPrototypeFormImplToJson(
  ...
  'type': instance.type,
  'nomorDokumenIzinPemanfaatanRuang': instance.nomorDokumenIzinPemanfaatanRuang,
...
_$PrototypeFormImpl _$$PrototypeFormImplFromJson(Map<String, dynamic> json) =>
    _$PrototypeFormImpl(
      ...
      koefisienLantaiBangunanKlbUnit:
          json['koefisienLantaiBangunanKlbUnit'] as String,
      koefisienDasarHijauKdh: (json['koefisienDasarHijauKdh'] as num)
          .toDouble(),
      koefisienDasarHijauKdhUnit: json['koefisienDasarHijauKdhUnit'] as String,
      provinceId: (json['provinceId'] as num).toInt(),
      provinceName: json['provinceName'] as String,
...
Map<String, dynamic> _$$PrototypeFormImplToJson(
  _$PrototypeFormImpl instance,
) => <String, dynamic>{
  'type': instance.type,
  'nomorDokumenIzinPemanfaatanRuang': instance.nomorDokumenIzinPemanfaatanRuang,
  'garisSempadanBangunanGsb': instance.garisSempadanBangunanGsb,
