...
class _$MonitoringItemModelImpl implements _MonitoringItemModel {
  ...
  @override
  String toString() {
    return 'MonitoringItemModel(id: $id, supervisorId: $supervisorId, title: $title, supervisorName: $supervisorName, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, supervisorId, title, supervisorName, createdAt);
