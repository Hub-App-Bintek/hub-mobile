...
class FinalDesignScreen extends StatelessWidget {
  const FinalDesignScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final designs = [
      const _ProjectDocument(
        'Final Desain Konsultasi',
        'Disetujui 14 Feb 2025',
      ),
    ];

    return Scaffold(
      appBar: const PkpAppBar(title: 'Final Desain'),
