...
class _AuthApiService implements AuthApiService {
  ...
  @override
  Future<LoginResponse> verifyOtp(VerifyOtpRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  Future<ForgotPasswordVerificationResponse> verifyForgotPasswordOtp(
    VerifyForgotPasswordOtpRequest body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<ForgotPasswordVerificationResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ForgotPasswordVerificationResponse _value;
    try {
      _value = ForgotPasswordVerificationResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> registerDeviceToken(RegisterDeviceTokenRequest body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
