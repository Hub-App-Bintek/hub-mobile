...
class _MonitoringApiService implements MonitoringApiService {
  _MonitoringApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<MonitoringResponse> createMonitoringRequest(
    ...
    _data.addAll(body);
    final _options = _setStreamType<MonitoringResponse>(
  ...
  Future<List<ConstructionSupervisorModel>> getProfessionals(
    ...
    final _options = _setStreamType<List<ConstructionSupervisorModel>>(
  ...
  Future<List<MonitoringItemModel>> getReports(int monitoringId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<MonitoringItemModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<ReportDetailModel> getReportDetail(int reportId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ReportDetailModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<MonitoringContractModel> approveContract(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<MonitoringContractModel>(
  ...
  Future<MonitoringRequestModel> approveCompletion(int requestId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MonitoringRequestModel>(
      Options(method: 'PUT', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<MonitoringDocumentModel> uploadDocument(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<MonitoringDocumentModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<List<MonitoringDocumentModel>> getDocuments(int monitoringId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<MonitoringDocumentModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<MonitoringDetailModel> getMonitoringDetail(int monitoringId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MonitoringDetailModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<List<MonitoringRequestItem>> getMonitoringRequests({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<MonitoringRequestItem>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/monitoring/requests',
  ...
  Future<List<MonitoringContractModel>> getContracts(int monitoringId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<MonitoringContractModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<JobCompletionModel> getJobCompletion(int requestId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<JobCompletionModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/monitoring/requests/${requestId}/completion',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late JobCompletionModel _value;
    try {
      _value = JobCompletionModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
