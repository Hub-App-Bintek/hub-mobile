...
class _ContractApiService implements ContractApiService {
  ...
  Future<Contract> getContract(String consultationId) async {
    ...
    final _options = _setStreamType<Contract>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<UploadContractResponse> createDraft(
    ...
    final _options = _setStreamType<UploadContractResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<Contract> approve(String contractId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
