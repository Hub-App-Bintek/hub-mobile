...
class _ContractApiService implements ContractApiService {
  ...
  @override
  Future<Contract> getContract(String consultationId) async {
  ...
  Future<List<ContractVersionResponse>> getContractVersions(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ContractVersionResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late List<ContractVersionResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ContractVersionResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<Contract> requestApproval(String contractId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<Contract> rejectPost(String contractId, String reason) async {
    final _extra = <String, dynamic>{};
  ...
  @override
  Future<Contract> signContract(String contractId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<Contract> requestPayment(String contractId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
